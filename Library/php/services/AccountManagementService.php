...
class AccountManagementService {
     ...
     */
    public function createLibrarianAccount($username, $email, $name, $password, $physical_id, $contactNumber) {
        ...
        try {
            ...
            $accountId = $this->accountDAO->createAccount($username, $passwordHash, 'Librarian', $name, $email, $physical_id, $contactNumber);
            $this->conn->commit();
            return $accountId;
        } catch (Exception $e) {
            $this->conn->rollback();
